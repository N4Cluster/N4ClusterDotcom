...
const pillars = [
  {
    ...
    metric: { value: "$0.50", label: "per order — regardless of ticket size" },
  },
  {
    id: "hub",
    number: "02",
      ...
      <section className="py-16 md:py-20" style={{ background: "#040d1c" }}>
        <Container size="lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              { title: "No commission. Ever.", body: "Not now. Not later. Not disguised as a service fee. Flat $99/month plus $0.50 per order." },
